...
2. Edit the file `script.js` in this repository and replace the placeholder `YOUR_MAKE_WEBHOOK_URL` with your actual webhook URL.
3. Commit and push the changes to the `main` branch. GitHub Pages will automatically redeploy the site with the updated integration.
